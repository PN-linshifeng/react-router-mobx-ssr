...
export default ()=> {
  ...
  <div className="container-full footer">
    ...
    <div className="copyright">
      <div className="container">
					如有查询，请联系：info@zhiku28.com <br />风险声明：外汇保证金交易涉及较高风险，可能不适合所有投资者。本网站及在线讲座所包含的内容及观点并不构成任何投资性产品的交易邀请或建议。<br />本公司不会为任何投资者直接或间接根据这些资料作出的投资决定所造成的损失负责。 <br />ZHIKU28-COPYRIGHT © 2018 保留所有版权<br />
      </div>
    </div>
  </div>
		)
